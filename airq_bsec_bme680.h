...
class AirQualityBsecBme680 {
  public:
    ...
    String name;
    uint8_t i2caddr;
    double rawTemperature=0.0, temperature=0.0, pressure=0.0, rawHumidity=0.0, humidity=0.0,
        gasResistance=0.0, iaq=0.0, iaqAccuracy=0.0, staticIaq=0.0, co2=0.0, voc=0.0;
    time_t startTime=0;
    bool bStartup=false;
    bool bActive = false;
    String errmsg="";
