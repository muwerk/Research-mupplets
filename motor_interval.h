...
class MotorInterval {
  public:
    /*! MotorInterval implements a simple dc motor whose advance is controlled
     * by a sensor switch triggered by a notch wheel.
     *
     * The connection requires one digital ouput GPIO pin for the motor driver
     * and one digital input pin for the sensor switch.
     *
     * It is possible to start the motor and optionally specify how many
     * intervals shall the motor advance before automatically stopping. It is
     * also possible to explicitely stop the motor before the requested number
     * of intervals will be reached. The current interval will be completed
     * before stopping. During motion, it is also possible to change the number
     * of intervals requested.
     *
